...
unit class Syndicate::FeedResult:ver<0.0.4>:auth<zef:sasha>;
...
A small typed record holding the detected L<C<FeedFormat>|rakudoc:Syndicate::Parse>
...
=item C<$.format> - The detected L<C<FeedFormat>|rakudoc:Syndicate::Parse>
